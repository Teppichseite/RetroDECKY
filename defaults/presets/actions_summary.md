...
This file provides an overview of all actions defined in actions.json.
...
- **Video Recording On/Off** (`general-video-recording-onoff`)
  ...
  - Emulators: Dolphin (Standalone), Primehack (Standalone), PCSX2 (Standalone), PPSSPP (Standalone), RetroArch
